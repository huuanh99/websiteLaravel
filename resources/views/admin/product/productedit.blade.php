      ...
      <form action="{{ route('editproduct') }}" method="post" enctype="multipart/form-data">
        ...
        <table class="form">
          ...
          <tr>
            ...
            <td>
              <input value="{{ $product->price }}" required name="price" type="number" placeholder="Enter Price..." class="medium" />
            </td>
          </tr>
           <tr>
            <td>
            ...
            <td>
              <input value="{{ $product->oldprice }}" name="oldprice" type="number" placeholder="Enter Old Price..." class="medium" />
            </td>
          </tr>
